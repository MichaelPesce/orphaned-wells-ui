...
Create the Google service accounts and JSON keys before adding these secrets.
See [Create Google service-account keys](/docs/install/gcp_setup#create-google-service-account-keys)
for the storage runtime, Document AI runtime, and deployment/Terraform account
definitions.
