...
- A Google identity with the [deployment and Terraform service-account permissions](/docs/install/gcp_setup#grant-deployment-and-terraform-access), either as your human `gcloud` account or as the `ogrre-deployment-ci` service account.
