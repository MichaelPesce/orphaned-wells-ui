    ...
    <div>
      ...
      <div style={{ lineHeight: 1.7 }}>
        ...
        <ul>
          ...
          <li>Reserve a [static external IP address](https://console.cloud.google.com/networking/addresses/list?invt=Abuaug&project=tidy-outlet-412020) for the instance.</li>
          <li>Copy SSH keys from the other servers so you can log in.</li>
          <li>[Increase the boot disk size](https://console.cloud.google.com/compute/disks?invt=Abuaug&project=tidy-outlet-412020) from <code>10 GB</code> to <code>20 GB</code>.</li>
        </ul>
        ...
        <ul>
          ...
          <li>[Install Docker](https://docs.docker.com/engine/install/debian/) following the standard Docker installation steps for Ubuntu.</li>
        </ul>

        <h3>3. Domain name and DNS</h3>
        <ul>
          <li>In [Google Cloud DNS](https://console.cloud.google.com/net-services/dns/zones?project=tidy-outlet-412020), add a new A record using the reserved static IP address.</li>
        ...
        <ul>
          <li>Add [custom domain](https://console.cloud.google.com/appengine/settings/domains?project=tidy-outlet-412020) in App Engine.</li>
        ...
        <ul>
          ...
          <li>In [Google OAuth](https://console.cloud.google.com/apis/credentials?project=tidy-outlet-412020) credentials, add both of the following as authorized origins and redirect URIs:</li>
          <ul>
